...
from tool.lqa_loss_trainer import build_lqa_trainer
...
def main():
    ...
    print(f"LQA config: {lqa_cfg}")
    print("=" * 80)

    trainer_cls = build_lqa_trainer(lqa_cfg)
